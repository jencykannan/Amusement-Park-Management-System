...
<body>
    ...
    <div class="container">
        ...
        $resultKids = $mysqli->query("SELECT * FROM rides WHERE age_restriction < 15 AND R_type NOT IN ('Thrill', 'Dark')");
        ...
        $resultAdult = $mysqli->query("SELECT * FROM rides WHERE age_restriction >=15");
